 ...
 */
public class GetCssHandler implements AndServerRequestHandler {
    @Override
    public void handle(HttpRequest request, HttpResponse response, HttpContext context) throws HttpException, IOException {
        File file = new File(SPHelper.getUploadIndex(ReaderApplication.getInstance().getApplicationContext()).replace("index.html", "css/index.css"));
        if (file.exists()) {
