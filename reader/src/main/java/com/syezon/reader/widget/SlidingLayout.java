...
import com.syezon.reader.widget.slider.Slider;
...
public class SlidingLayout extends ViewGroup {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        return mCanMove && (mSlider.onTouchEvent(event) || super.onTouchEvent(event));
...
//        return super.onInterceptTouchEvent(ev);
    ...
    public void setInterruput(boolean interruput){
        isInterruput=interruput;
        Log.e("interruput","  "+isInterruput);
    }
