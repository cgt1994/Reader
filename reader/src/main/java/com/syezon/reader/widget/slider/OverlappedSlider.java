...
public class OverlappedSlider extends BaseSlider {
    ...
    private SrcollListener srcollListener;

    public interface SrcollListener {
        void isMoving();
    }

    public void setmScroller(SrcollListener listener) {
        srcollListener = listener;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (srcollListener != null && Math.abs(event.getX()-startX)>50) {
                    srcollListener.isMoving();
                }
    ...
    public boolean moveToNext() {
        ...
        if (prevView != null) {
            Log.e("get1 nextview add", "prevView   " + prevView);
        ...
        if (getAdapter().hasNext()) {
            ...
            if (newNextView != null) {
                View updateNextView = getAdapter().getView(newNextView, getAdapter().getNextChapter(), getAdapter().getNext());
//                updateNextView.setOnTouchListener(new View.OnTouchListener() {
//                    @Override
...
//                });
            ...
            Log.e("get1 nextview add", "newNextView" + newNextView);
    ...
    public boolean moveToPrevious() {
        ...
        if (getAdapter().hasPrevious()) {
            ...
            if (newPrevView != null) {
                ...
                View updatedPrevView = getAdapter().getView(newPrevView, getAdapter().getPreChapter(), getAdapter().getPrevious());
            ...
            Log.e("get1 preview add", "newNextView" + newPrevView);
